...
export default async function Home() {
  const query = await getData(`{
    ...
    'preface':*[_type=="info" && slug.current=="productions"][0]{title,content,"imageURL":cover.asset->url},
  ...
  return (
          ...
          <div className="w-full grid grid-cols-12 col-span-full  pb-[160px]">
            ...
            <div className="w-[100vw] grid grid-cols-12">
              ...
              <div className={`text-nav text-center mb-[40px] border-[--black] border rounded-full uppercase w-full py-[8px] bottom-[--bar] px-[10px]`}>Productions</div>
                          {preface?(
