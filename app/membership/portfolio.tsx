...
<React.Fragment>
          ...
          <motion.div  className="absolute flex left-0 top-0 items-top" ref={ref} style={{x:xTranslation}}>
               {[...work, ...work, ...work].map((item,i)=>{
                 return(
                  ...
                  <Link href={`/membership/${section}/${item.slug.current}`}>
                      <div className="projHold p-[10px] grid grid-cols-[1fr_5fr] items-start">
