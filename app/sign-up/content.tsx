            ...
            <React.Fragment >
                ...
                {signup==0?(
                     <div className="w-full grid grid-cols-12 col-span-full">
                        ...
                        <div className="fixed w-[100vw] bottom-[--bar] grid grid-cols-12 px-[20px] md:px-0"><div className={`col-span-12 col-start-1 md:col-span-8 md:col-start-3 xl:col-span-4 xl:col-start-5  py-[10px] bg-[--black] text-white uppercase relative border border-black text-nav text-center rounded-full`} onClick={() => setSign(1)}>{`Apply to 400m: ${sec==0?"Production":"D+D"}`}</div></div>
